...
namespace Meta.XR.MetaWand.Editor
{
    ...
    {
        public List<PromptData> Data = new();
    }
    ...
    internal struct PromptData
    {
        ...
        public bool SearchInAssetDatabase;
    ...
    internal struct Asset
    {
        ...
        // Indicates whether asset has metadata. No metadata means no write to cache.
        public bool IsReady => !string.IsNullOrEmpty(AssetId);
    }
}
