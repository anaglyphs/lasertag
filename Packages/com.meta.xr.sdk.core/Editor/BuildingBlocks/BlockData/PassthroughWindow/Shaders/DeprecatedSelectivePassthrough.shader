/// NOTE: This shader requires Premultiplied Alpha to be disabled in the project settings.
/// Please ensure that Premultiplied Alpha is turned off for this shader to work correctly.
/// Premultiplied Alpha can be turned off by setting OVRManager.eyeFovPremultipliedAlphaModeEnabled to false.

Shader "Oculus/DeprecatedSelectivePassthrough"
{
    Properties
    {
