...
public class OVRTrackedKeyboardHands : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        if (LeftHandOverKeyboard || RightHandOverKeyboard)
        {
            ...
            OVRPlugin.SetInsightPassthroughKeyboardHandsIntensity(KeyboardTracker.PassthroughOverlay.layerId,
                handsIntensity);
        }
    }
    ...
    private void SetHandModelsEnabled(bool enableLeftModel, bool enableRightModel)
    {
        ...
        if (leftHandSkeletonRenderer_ != null)
        {
            ...
            {
                leftHandSkeletonRendererGO_ =
                    leftHandSkeletonRenderer_.gameObject.transform.Find("SkeletonRenderer")?.gameObject;
                rightHandSkeletonRendererGO_ = rightHandSkeletonRenderer_.gameObject.transform.Find("SkeletonRenderer")
                    ?.gameObject;
            }
    ...
    private void RetargetHandTrackingToHandPresence()
    {
        ...
        for (int index = 0; index < boneMappings_.Length; index++)
        {
            ...
            boneMappings_[index].LeftPresenceTransform =
                leftHandRoot_.FindChildRecursive(entry.HandPresenceLeftBoneName);
            ...
            boneMappings_[index].RightPresenceTransform =
                rightHandRoot_.FindChildRecursive(entry.HandPresenceRightBoneName);
