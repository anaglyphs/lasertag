...
[GuideItems]
internal class FaceTrackingManualSetupInfo : UPSTGuidedSetup
{
    ...
    private List<IUserInterfaceItem> GetItems()
    {
        ...
        return new List<IUserInterfaceItem>
        {
            ...
            Bullet("Select <b>Natural Facial Expressions</b>."),
            Bullet("Toggle Natural Facial Expressions to <b>on</b>."),
        };
    }
    ...
    internal override GuideWindow CreateWindow()
    {
        ...
        var title = "Setup Guide - Face Tracking";
        var description = "Face tracking technology is used to make the user avatar's expressions look more natural by detecting facial movements and mirroring them in VR. The Meta Quest Pro headset is the only device that supports this feature. To enable:";
