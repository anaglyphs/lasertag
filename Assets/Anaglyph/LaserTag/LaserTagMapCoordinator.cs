...
namespace Anaglyph.LaserTag
{
	...
	public class LaserTagMapCoordinator : MonoBehaviour
	{
		...
		private static string Localize(string key) => key == null ? null : MenuCopy.Get("Game", key);
		...
		private static void ReportAlignmentRejection() => UserErrors.RaiseLocalized(UserErrorArea.Game,
			"error.alignment-title", "error.alignment-details", MenuCopy.Get("Game", "alignment.request-rejected"));
