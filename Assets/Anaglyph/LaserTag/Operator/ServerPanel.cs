...
namespace Anaglyph.Lasertag.Operator
{
	public sealed class ServerWindow : EditorWindow
	{
		...
		private void CreateUI()
		{
			...
			connectingPage.Add(new Label("Connecting...") { style = { unityFontStyleAndWeight = FontStyle.Bold } });
			//
			// var cancelButton = new Button(NetcodeManagement.Disconnect)
			// {
			// 	text = "Cancel",
			// 	style =
			// 	{
			...
			// 	}
			// };
			// connectingPage.Add(cancelButton);
			...
			var matchSettingsLabel = new Label("Match Settings") { style = { unityFontStyleAndWeight = FontStyle.Bold, marginTop = 10 } };
			...
			var matchRunningLabel = new Label("Match Running") { style = { unityFontStyleAndWeight = FontStyle.Bold, marginTop = 10 } };
