...
namespace Anaglyph.XRTemplate.SharedSpaces
{
	...
	public class MetaAnchorColocatorOld : MonoBehaviour, IColocator
	{
		public static MetaAnchorColocatorOld Instance { get; private set; }
		...
		private void OnCanonPosesSyncChanged(SyncDictionary<Guid, Pose>.EventData eventData)
		{
			ReconcileEntries();
		}
		...
		{
			return GetAvailability() == AnchorAvailability.Available;
		}
