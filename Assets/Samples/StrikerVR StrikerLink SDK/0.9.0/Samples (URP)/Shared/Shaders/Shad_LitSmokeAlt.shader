...
Shader "StrikerVR/URP/Striker Lit Smoke (Alt)"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_EmissiveColor("Emissive Color", Color) = (0,0,0,0)
		_ColorMultiplier("Color Multiplier", Float) = 1
		[ASEEnd]_SmokeTexture("Smoke Texture", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 colAlbedo14 = ( IN.ase_color * _ColorMultiplier );
				
				float2 uv_SmokeTexture = IN.ase_texcoord7.xy * _SmokeTexture_ST.xy + _SmokeTexture_ST.zw;
				float4 tex2DNode19 = tex2D( _SmokeTexture, uv_SmokeTexture );
				float fAmbientOcclusion20 = tex2DNode19.r;
				
				float fAlpha23 = ( IN.ase_color.a * tex2DNode19.a );
				
				float3 Albedo = colAlbedo14.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = _EmissiveColor.rgb;
				float3 Specular = 0.5;
				float Metallic = 0.0;
				float Smoothness = 0.5;
				float Occlusion = fAmbientOcclusion20;
				float Alpha = fAlpha23;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_SmokeTexture = IN.ase_texcoord2.xy * _SmokeTexture_ST.xy + _SmokeTexture_ST.zw;
				float4 tex2DNode19 = tex2D( _SmokeTexture, uv_SmokeTexture );
				float fAlpha23 = ( IN.ase_color.a * tex2DNode19.a );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_SmokeTexture = IN.ase_texcoord3.xy * _SmokeTexture_ST.xy + _SmokeTexture_ST.zw;
				float4 tex2DNode19 = tex2D( _SmokeTexture, uv_SmokeTexture );
				float fAlpha23 = ( IN.ase_color.a * tex2DNode19.a );
...
/*ASEBEGIN
Version=18935
-2560;-1;2560;1380;3393.622;1449.403;1.781751;True;False
Node;AmplifyShaderEditor.VertexColorNode;15;-1952,-587.5;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;19;-2086,-331.5;Inherit;True;Property;_SmokeTexture;Smoke Texture;2;0;Create;True;0;0;0;False;0;False;-1;42a663fa1db4a8a479611a8d4e1af010;762d8d1518de01243b8d73246d1c0d3b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;17;-1485,-490.5;Inherit;False;Property;_ColorMultiplier;Color Multiplier;1;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-1709,-378.5;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-1248,-617.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;23;-1316.47,-318.8336;Inherit;False;fAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;20;-1664,-132.5;Inherit;False;fAmbientOcclusion;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;14;-1077,-586.5;Inherit;False;colAlbedo;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;10;-647,-108.5;Inherit;False;Property;_EmissiveColor;Emissive Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;24;-461.4697,306.1664;Inherit;False;23;fAlpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;21;-686,224.5;Inherit;False;20;fAmbientOcclusion;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-441,63.5;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-534,137.5;Inherit;False;Constant;_Float1;Float 1;1;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;13;-407,-284.5;Inherit;False;14;colAlbedo;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-432,425.5;Inherit;False;Constant;_Float2;Float 2;1;0;Create;True;0;0;0;False;0;False;0.001;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;StrikerVR/URP/Striker Lit Smoke (Alt);94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;1;637917709569700435;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,-1;0;Translucency;0;0;  Translucency Strength;1,False,-1;0;  Normal Distortion;0.5,False,-1;0;  Scattering;2,False,-1;0;  Direct;0.9,False,-1;0;  Ambient;0.1,False,-1;0;  Shadow;0.5,False,-1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=36E8F9AFB12E4143267974BEA2F5657928B13ADE